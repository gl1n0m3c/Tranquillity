...
DEVICE_SHOW.onclick = function() {
    document.getElementById("DEVICE").style.display = "block";
    document.getElementById("READINGS").style.display = "none";
    document.getElementById("PARAMS").style.display = "none";
}

READINGS_SHOW.onclick = function() {
    document.getElementById("DEVICE").style.display = "none";
...
zapros(host +'/save/'+ input4.value+ '/' + input5.value + '/' + input6.value +  '/' + input7.value +  '/' + input8.value +  '/' + input9.value +  '/'
...
function get(n) {
    if (n==1){
        ...
        zapros(host + '/save_temperature/' + input1.value)
        console.log(input1.value)
}   if (n==2){
        let input2 = document.getElementById('MaxH')
        if (input2.value<101){
        zapros(host + '/save_air_humidity/' + input2.value)
        console.log(input2.value)}
}   if (n==3){
        let input3 = document.getElementById('MaxHb')
        if (input3.value<101){
        zapros(host + '/save_ground_humidity/' + input3.value)
...
function knopki(){
    k += 1
    if (k % 2 == 1){ 
        windows(host + "/open_windows")
}   if (k % 2 == 0){ 
        windows(host + "/close_windows")}}

function knopki2(){
    k1 += 1   
    if (k1 % 2 == 1){
        humidity(host + "/start_humidity_system")}
    if (k1 % 2 == 0){
        humidity(host + "/stop_humidity_system")}} 

function knopki3(){
    k2 += 1
    if (k2 % 2 == 1){
        borozdka1(host + "/start_wattering/1")}
    if (k2 % 2 == 0){
       borozdka1(host + "/stop_wattering/1")}}
 
function knopki4(){
    k3 += 1
    if (k3 % 2 == 1){
        borozdka2(host + "/start_wattering/2")}
    if (k3 % 2 == 0){
        borozdka2(host + "/stop_wattering/2")}}

function knopki5(){
    k4 += 1
    if (k4 % 2 == 1){
        borozdka3(host + "/start_wattering/3")
}   if (k4 % 2 == 0) {
        borozdka3(host + "/stop_wattering/3")}}

function knopki6(){
    k5 += 1
    if (k5 % 2 == 1){
        borozdka4(host + "/start_wattering/4")
}   if (k5 % 2 == 0){
        borozdka4(host + "/stop_wattering/4")}}

function knopki7(){
    k6 += 1
    if (k6 % 2 == 1){
        borozdka5(host + "/start_wattering/5")
}   if (k6 % 2 == 0){
        borozdka5(host + "/stop_wattering/5")}}

function knopki8(){
    k7 += 1
    if (k7 % 2 ==1){
        borozdka6(host + "/start_wattering/6")
}   if (k7 % 2 == 0){
        borozdka6(host + "/stop_wattering/6")}}
